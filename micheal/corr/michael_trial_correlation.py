...
def _component_arrays(values: np.ndarray, cue: np.ndarray) -> dict:
    # Results column 3: 1 = right item tested late, left tested early, 2 = left item tested late, right tested early.
    # Contra and Ipsi is based on the tested late item
